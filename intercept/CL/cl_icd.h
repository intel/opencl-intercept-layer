...
typedef void* cl_api_clCreateSubDevicesEXT;
typedef void* cl_api_clRetainDeviceEXT;
typedef void* cl_api_clReleaseDeviceEXT;
...
typedef void* cl_api_clCreateFromEGLImageKHR;
typedef void* cl_api_clEnqueueAcquireEGLObjectsKHR;
typedef void* cl_api_clEnqueueReleaseEGLObjectsKHR;
...
typedef void* cl_api_clCreateEventFromEGLSyncKHR;
