...
{
    INIT_NATIVE_LAYER_FUNCTION( clGetPlatformIDs );
    INIT_NATIVE_LAYER_FUNCTION( clGetPlatformInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceIDs );
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceInfo );
    INIT_NATIVE_LAYER_FUNCTION( clCreateContext );
    INIT_NATIVE_LAYER_FUNCTION( clCreateContextFromType );
    INIT_NATIVE_LAYER_FUNCTION( clRetainContext );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseContext );
    INIT_NATIVE_LAYER_FUNCTION( clGetContextInfo );
    INIT_NATIVE_LAYER_FUNCTION( clCreateCommandQueue );
    INIT_NATIVE_LAYER_FUNCTION( clRetainCommandQueue );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseCommandQueue );
    INIT_NATIVE_LAYER_FUNCTION( clGetCommandQueueInfo );
    INIT_NATIVE_LAYER_FUNCTION( clSetCommandQueueProperty );
    INIT_NATIVE_LAYER_FUNCTION( clCreateBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clCreateImage2D );
    INIT_NATIVE_LAYER_FUNCTION( clCreateImage3D );
    INIT_NATIVE_LAYER_FUNCTION( clRetainMemObject );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseMemObject );
    INIT_NATIVE_LAYER_FUNCTION( clGetSupportedImageFormats );
    INIT_NATIVE_LAYER_FUNCTION( clGetMemObjectInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetImageInfo );
    INIT_NATIVE_LAYER_FUNCTION( clCreateSampler );
    INIT_NATIVE_LAYER_FUNCTION( clRetainSampler );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseSampler );
    INIT_NATIVE_LAYER_FUNCTION( clGetSamplerInfo );
    INIT_NATIVE_LAYER_FUNCTION( clCreateProgramWithSource );
    INIT_NATIVE_LAYER_FUNCTION( clCreateProgramWithBinary );
    INIT_NATIVE_LAYER_FUNCTION( clRetainProgram );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseProgram );
    INIT_NATIVE_LAYER_FUNCTION( clBuildProgram );
    INIT_NATIVE_LAYER_FUNCTION( clUnloadCompiler );
    INIT_NATIVE_LAYER_FUNCTION( clGetProgramInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetProgramBuildInfo );
    INIT_NATIVE_LAYER_FUNCTION( clCreateKernel );
    INIT_NATIVE_LAYER_FUNCTION( clCreateKernelsInProgram );
    INIT_NATIVE_LAYER_FUNCTION( clRetainKernel );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseKernel );
    INIT_NATIVE_LAYER_FUNCTION( clSetKernelArg );
    INIT_NATIVE_LAYER_FUNCTION( clGetKernelInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetKernelWorkGroupInfo );
    INIT_NATIVE_LAYER_FUNCTION( clWaitForEvents );
    INIT_NATIVE_LAYER_FUNCTION( clGetEventInfo );
    INIT_NATIVE_LAYER_FUNCTION( clRetainEvent );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseEvent );
    INIT_NATIVE_LAYER_FUNCTION( clGetEventProfilingInfo );
    INIT_NATIVE_LAYER_FUNCTION( clFlush );
    INIT_NATIVE_LAYER_FUNCTION( clFinish );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReadBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueWriteBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueCopyBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReadImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueWriteImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueCopyImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueCopyImageToBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueCopyBufferToImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueMapBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueMapImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueUnmapMemObject );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueNDRangeKernel );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueTask );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueNativeKernel );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueMarker );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueWaitForEvents );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueBarrier );
    INIT_NATIVE_LAYER_FUNCTION( clGetExtensionFunctionAddress );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromGLBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromGLTexture2D );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromGLTexture3D );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromGLRenderbuffer );
    INIT_NATIVE_LAYER_FUNCTION( clGetGLObjectInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetGLTextureInfo );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueAcquireGLObjects );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReleaseGLObjects );
    INIT_NATIVE_LAYER_FUNCTION( clGetGLContextInfoKHR );
#if defined(_WIN32)
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceIDsFromD3D10KHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D10BufferKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D10Texture2DKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D10Texture3DKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueAcquireD3D10ObjectsKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReleaseD3D10ObjectsKHR );
#endif
    INIT_NATIVE_LAYER_FUNCTION( clSetEventCallback );
    INIT_NATIVE_LAYER_FUNCTION( clCreateSubBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clSetMemObjectDestructorCallback );
    INIT_NATIVE_LAYER_FUNCTION( clCreateUserEvent );
    INIT_NATIVE_LAYER_FUNCTION( clSetUserEventStatus );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReadBufferRect );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueWriteBufferRect );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueCopyBufferRect );
    INIT_NATIVE_LAYER_FUNCTION( clCreateEventFromGLsyncKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateSubDevices );
    INIT_NATIVE_LAYER_FUNCTION( clRetainDevice );
    INIT_NATIVE_LAYER_FUNCTION( clReleaseDevice );
    INIT_NATIVE_LAYER_FUNCTION( clCreateImage );
    INIT_NATIVE_LAYER_FUNCTION( clCreateProgramWithBuiltInKernels );
    INIT_NATIVE_LAYER_FUNCTION( clCompileProgram );
    INIT_NATIVE_LAYER_FUNCTION( clLinkProgram );
    INIT_NATIVE_LAYER_FUNCTION( clUnloadPlatformCompiler );
    INIT_NATIVE_LAYER_FUNCTION( clGetKernelArgInfo );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueFillBuffer );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueFillImage );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueMigrateMemObjects );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueMarkerWithWaitList );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueBarrierWithWaitList );
    INIT_NATIVE_LAYER_FUNCTION( clGetExtensionFunctionAddressForPlatform );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromGLTexture );
#if defined(_WIN32)
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceIDsFromD3D11KHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D11BufferKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D11Texture2DKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromD3D11Texture3DKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCreateFromDX9MediaSurfaceKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueAcquireD3D11ObjectsKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReleaseD3D11ObjectsKHR );
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceIDsFromDX9MediaAdapterKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueAcquireDX9MediaSurfacesKHR );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueReleaseDX9MediaSurfacesKHR );
#endif
    INIT_NATIVE_LAYER_FUNCTION( clCreateCommandQueueWithProperties );
    INIT_NATIVE_LAYER_FUNCTION( clCreatePipe );
    INIT_NATIVE_LAYER_FUNCTION( clGetPipeInfo );
    INIT_NATIVE_LAYER_FUNCTION( clSVMAlloc );
    INIT_NATIVE_LAYER_FUNCTION( clSVMFree );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMFree );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMMemcpy );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMMemFill );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMMap );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMUnmap );
    INIT_NATIVE_LAYER_FUNCTION( clCreateSamplerWithProperties );
    INIT_NATIVE_LAYER_FUNCTION( clSetKernelArgSVMPointer );
    INIT_NATIVE_LAYER_FUNCTION( clSetKernelExecInfo );
    INIT_NATIVE_LAYER_FUNCTION( clGetKernelSubGroupInfoKHR );
    INIT_NATIVE_LAYER_FUNCTION( clCloneKernel );
    INIT_NATIVE_LAYER_FUNCTION( clCreateProgramWithIL );
    INIT_NATIVE_LAYER_FUNCTION( clEnqueueSVMMigrateMem );
    INIT_NATIVE_LAYER_FUNCTION( clGetDeviceAndHostTimer );
    INIT_NATIVE_LAYER_FUNCTION( clGetHostTimer );
    INIT_NATIVE_LAYER_FUNCTION( clGetKernelSubGroupInfo );
    INIT_NATIVE_LAYER_FUNCTION( clSetDefaultDeviceCommandQueue );
    INIT_NATIVE_LAYER_FUNCTION( clSetProgramReleaseCallback );
    INIT_NATIVE_LAYER_FUNCTION( clSetProgramSpecializationConstant );
    INIT_NATIVE_LAYER_FUNCTION( clCreateBufferWithProperties );
    INIT_NATIVE_LAYER_FUNCTION( clCreateImageWithProperties );
    INIT_NATIVE_LAYER_FUNCTION( clSetContextDestructorCallback );
}
#endif
