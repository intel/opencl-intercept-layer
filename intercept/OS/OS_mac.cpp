...
const char* Services::CONFIG_FILE = "config.conf";
const char* Services::SYSTEM_DIR = "/etc";
const char* Services::LOG_DIR = NULL;
bool Services::APPEND_PID = false;

Services::Services( void* poGlobalData ) {}

bool Services::GetControl(
...
bool Services::GetControlFromFile(
