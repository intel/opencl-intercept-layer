...
Linux and OSX: [![Linux OSX Build Status](https://travis-ci.org/intel/opencl-intercept-layer.svg?branch=master)](https://travis-ci.org/intel/opencl-intercept-layer) | Windows: [![Windows Build Status](https://ci.appveyor.com/api/projects/status/l4bb04457hid3nwy/branch/master?svg=true)](https://ci.appveyor.com/project/bashbaug/opencl-intercept-layer/branch/master)
